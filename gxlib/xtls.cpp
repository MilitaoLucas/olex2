  ...
  float scale, const olxstr &obj_name, short obj_type) const
{
  ...
  short m_c[3] = {
    static_cast<short>(OLX_GetRValue(start_color)+OLX_GetRValue(end_color)),
    static_cast<short>(OLX_GetGValue(start_color)+OLX_GetGValue(end_color)),
    static_cast<short>(OLX_GetBValue(start_color)+OLX_GetBValue(end_color)),
  };
  short s_c[3] = {
    static_cast<short>(OLX_GetRValue(end_color)-OLX_GetRValue(start_color)),
    static_cast<short>(OLX_GetGValue(end_color)-OLX_GetGValue(start_color)),
    static_cast<short>(OLX_GetBValue(end_color)-OLX_GetBValue(start_color)),
  };
  for (int i=0; i < 3; i++) {
    m_c[i] /= 2;
    s_c[i] /= 2;
